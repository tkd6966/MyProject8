...
void AMyProject8Character::NotifyControllerChanged()
{
...
void AMyProject8Character::OnDeath()
{
	UE_LOG(LogTemp, Error, TEXT("Character is Dead!"));
}

float AMyProject8Character::TakeDamage(float DamageAmount, FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
...
void AMyProject8Character::AddHealth(float Amount)
{
